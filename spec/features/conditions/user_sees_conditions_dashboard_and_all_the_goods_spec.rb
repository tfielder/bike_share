...
describe 'as a visitor' do
  describe 'when visiting /condition/2 show page' do
    it 'shows unique conditions for show page' do
      ...
      condition_2 = Condition.create(date:"09/03/2018", max_temp:90.0, mean_temp:75.0, min_temp:42.0, mean_humidity:27.0, mean_visibility:20.0, mean_wind_speed:30.0, precip:11.5)
      condition_2 = Condition.create(date:"09/04/2018", max_temp:87.0, mean_temp:78.0, min_temp:43.0, mean_humidity:14.0, mean_visibility:45.0, mean_wind_speed:32.0, precip:2.3)
      condition_2 = Condition.create(date:"09/05/2018", max_temp:93.0, mean_temp:72.0, min_temp:40.0, mean_humidity:30.0, mean_visibility:8.0, mean_wind_speed:9.0, precip:1.0)
