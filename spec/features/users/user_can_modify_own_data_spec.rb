...
describe 'As a registered user' do
  before(:each) do
    let!(:user1) {User.create!(name: "Beemo", email: "bmo@email.com", password: "pass", password_confirmation: "pass")}
    let!(:user2) {User.create!(name: "Zebra", email: "zebra@email.com", password: "test", password_confirmation: "test")}
